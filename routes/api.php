...
Route::post('/question/follower','QuestionFollowsController@follower')->middleware('auth:api');

Route::post('/question/follow','QuestionFollowsController@followThisQuestion')->middleware('auth:api');
