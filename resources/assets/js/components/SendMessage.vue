            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <textarea name="body" v-model="body" v-if="!status" v-validate="'required|body'" class="form-control" cols="10" rows="4"></textarea>
                        <div v-show="errors.has('body')" class="alert alert-danger">
                            {{ errors.first('body') }}
                        </div>
