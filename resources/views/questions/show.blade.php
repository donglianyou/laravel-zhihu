                    ...
                    <div class="actions">
                        @if(Auth::check() && Auth::user()->owns($question))
                            ...
                            <form action="/questions/{{ $question->id }}" method="POST" class="delete-form">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
                                <button class="button is-maked delete-button">删除</button>
                            </form>
                        @endif
            ...
            <div class="col-md-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {{--@else
                            <a href="{{ url('login') }}" class="btn btn-default">关注问题</a>
                        @endif--}}
                        <a href="{{ Auth::check() ? '#editor' : url('login') }}" class="btn btn-primary pull-right">撰写答案</a>
                    </div>
                </div>
            </div>
            <div class="col-md-8 col-md-offset-1">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="/questions/{{ $question->id }}/answer" method="post">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-success pull-right" value="提交答案">
                            </div>
                         </form>
                         @else
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img src="{{ $question->user->avatar }}" width="36" alt="{{ $question->user->name }}">
                                </a>
                            </div>
                            <div class="media-body">
                                <h4 class="media-heading">
